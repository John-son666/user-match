    ...
    <template v-if="user">
        ...
        <van-grid :border="false">
            <van-grid-item text="创建的队伍" to="/user/team/create">
                <template #icon>
                    <van-icon class-prefix="my-icon" name="wochuangjiande" size="25" style="margin-bottom: 8px"/>
                </template>
            </van-grid-item>
            <van-grid-item text="加入的队伍" to="/user/team/join">
                <template #icon>
                    <van-icon class-prefix="my-icon" name="jiarubanji" size="25" style="margin-bottom: 8px"/>
                </template>
            </van-grid-item>
